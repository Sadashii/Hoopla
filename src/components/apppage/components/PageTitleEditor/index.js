  ...
  return (
    <FlexBox fullWidth column className={styles.pageTitleEditor}>
      <FlexBox align className={styles.pageDisplayOptions}>
        {pageData.icon === null && (
          <div className={clsx(stylesP.navOptionLightBold,
            styles.pageDisplayOption)} onClick={addIcon}>🙂 Add icon</div>
        )}
          ...
          <>
            <Tooltip title={"Change icon"}>
              <div className={styles.pageIcon}
                   onClick={() => setShowIconSelector(true)} ref={iconDivRef}>
                ...
                {showIconSelector && (
                  <IconSelector onClick={onIconChange}
